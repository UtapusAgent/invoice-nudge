const APP={"name":"Invoice Nudge","category":"Invoice tracker","description":"Track client invoices, due dates, and payment status.","features":["Invoice CRUD","Due soon view","Status updates","CSV export"]};
